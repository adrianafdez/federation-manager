...
class AppQoSProfile(Model):
    def __init__(self, latency_constraints: str=None, bandwidth_required: int=None, multi_user_clients: str='APP_TYPE_SINGLE_USER', no_of_users_per_app_inst: int=1, app_provisioning: bool=True):  # noqa: E501
        """AppQoSProfile - a model defined in Swagger

        :param latency_constraints: The latency_constraints of this AppQoSProfile.  # noqa: E501
        :type latency_constraints: str
        :param bandwidth_required: The bandwidth_required of this AppQoSProfile.  # noqa: E501
        :type bandwidth_required: int
        :param multi_user_clients: The multi_user_clients of this AppQoSProfile.  # noqa: E501
        :type multi_user_clients: str
        :param no_of_users_per_app_inst: The no_of_users_per_app_inst of this AppQoSProfile.  # noqa: E501
        :type no_of_users_per_app_inst: int
        :param app_provisioning: The app_provisioning of this AppQoSProfile.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AppQoSProfile':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AppQoSProfile of this AppQoSProfile.  # noqa: E501
        :rtype: AppQoSProfile
        """
    ...
    def latency_constraints(self) -> str:
        """Gets the latency_constraints of this AppQoSProfile.
        ...
        :return: The latency_constraints of this AppQoSProfile.
        :rtype: str
        """
    ...
    def latency_constraints(self, latency_constraints: str):
        """Sets the latency_constraints of this AppQoSProfile.

        Latency requirements for the application. Allowed values (non-standardized) are none, low and ultra-low. Ultra-Low may corresponds to range 15 - 30 msec, Low correspond to range 30 - 50 msec. None means 51 and above  # noqa: E501

        :param latency_constraints: The latency_constraints of this AppQoSProfile.
        :type latency_constraints: str
        """
    ...
    def bandwidth_required(self, bandwidth_required: int):
        """Sets the bandwidth_required of this AppQoSProfile.

        Data transfer bandwidth requirement (minimum limit) for the application. It should in Mbits/sec  # noqa: E501

        :param bandwidth_required: The bandwidth_required of this AppQoSProfile.
        :type bandwidth_required: int
        """
    ...
    def multi_user_clients(self) -> str:
        """Gets the multi_user_clients of this AppQoSProfile.
        ...
        :return: The multi_user_clients of this AppQoSProfile.
        :rtype: str
        """
    ...
    def multi_user_clients(self, multi_user_clients: str):
        """Sets the multi_user_clients of this AppQoSProfile.

        Single user type application are designed to serve just one client. Multi user type application is designed to serve multiple clients  # noqa: E501

        :param multi_user_clients: The multi_user_clients of this AppQoSProfile.
        :type multi_user_clients: str
        """
    ...
    def no_of_users_per_app_inst(self) -> int:
        """Gets the no_of_users_per_app_inst of this AppQoSProfile.
        ...
        :return: The no_of_users_per_app_inst of this AppQoSProfile.
        :rtype: int
        """
    ...
    def no_of_users_per_app_inst(self, no_of_users_per_app_inst: int):
        """Sets the no_of_users_per_app_inst of this AppQoSProfile.

        Maximum no of clients that can connect to an instance of this application. This parameter is relevant only for application of type multi user  # noqa: E501

        :param no_of_users_per_app_inst: The no_of_users_per_app_inst of this AppQoSProfile.
        :type no_of_users_per_app_inst: int
        """
    ...
    def app_provisioning(self) -> bool:
        """Gets the app_provisioning of this AppQoSProfile.

        Define if application can be instantiated or not  # noqa: E501

        :return: The app_provisioning of this AppQoSProfile.
        :rtype: bool
        """
    ...
    def app_provisioning(self, app_provisioning: bool):
        """Sets the app_provisioning of this AppQoSProfile.

        Define if application can be instantiated or not  # noqa: E501

        :param app_provisioning: The app_provisioning of this AppQoSProfile.
        :type app_provisioning: bool
        """
