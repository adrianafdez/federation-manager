...
class AppComponentSpecsInner(Model):
    def __init__(self, service_name_nb: str=None, service_name_ew: str=None, component_name: str=None, artefact_id: ArtefactId=None):  # noqa: E501
        """AppComponentSpecsInner - a model defined in Swagger

        :param service_name_nb: The service_name_nb of this AppComponentSpecsInner.  # noqa: E501
        :type service_name_nb: str
        :param service_name_ew: The service_name_ew of this AppComponentSpecsInner.  # noqa: E501
        :type service_name_ew: str
        :param component_name: The component_name of this AppComponentSpecsInner.  # noqa: E501
        :type component_name: str
        :param artefact_id: The artefact_id of this AppComponentSpecsInner.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AppComponentSpecsInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AppComponentSpecs_inner of this AppComponentSpecsInner.  # noqa: E501
        :rtype: AppComponentSpecsInner
        """
        return util.deserialize_model(dikt, cls)

    @property
    def service_name_nb(self) -> str:
        """Gets the service_name_nb of this AppComponentSpecsInner.
        ...
        :return: The service_name_nb of this AppComponentSpecsInner.
        :rtype: str
        """
    ...
    def service_name_nb(self, service_name_nb: str):
        """Sets the service_name_nb of this AppComponentSpecsInner.

        Must be a valid RFC 1035 label name. This defines the DNS name via which the component can be accessed over NBI. Access via serviceNameNB is restricted on specific ports. Platform shall expose component access externally via this DNS name  # noqa: E501

        :param service_name_nb: The service_name_nb of this AppComponentSpecsInner.
        :type service_name_nb: str
        """
    ...
    def service_name_ew(self) -> str:
        """Gets the service_name_ew of this AppComponentSpecsInner.
        ...
        :return: The service_name_ew of this AppComponentSpecsInner.
        :rtype: str
        """
    ...
    def service_name_ew(self, service_name_ew: str):
        """Sets the service_name_ew of this AppComponentSpecsInner.

        Must be a valid RFC 1035 label name. This defines the DNS name via which the component can be accessed via peer components. Access via serviceNameEW is open on all ports.   Platform shall not expose serviceNameEW externally outside edge.  # noqa: E501

        :param service_name_ew: The service_name_ew of this AppComponentSpecsInner.
        :type service_name_ew: str
        """
    ...
    def component_name(self) -> str:
        """Gets the component_name of this AppComponentSpecsInner.

        Must be a valid RFC 1035 label name.  Component name must be unique with an application  # noqa: E501

        :return: The component_name of this AppComponentSpecsInner.
        :rtype: str
        """
    ...
    def component_name(self, component_name: str):
        """Sets the component_name of this AppComponentSpecsInner.

        Must be a valid RFC 1035 label name.  Component name must be unique with an application  # noqa: E501

        :param component_name: The component_name of this AppComponentSpecsInner.
        :type component_name: str
        """
    ...
    def artefact_id(self) -> ArtefactId:
        """Gets the artefact_id of this AppComponentSpecsInner.


        :return: The artefact_id of this AppComponentSpecsInner.
        :rtype: ArtefactId
        """
    ...
    def artefact_id(self, artefact_id: ArtefactId):
        """Sets the artefact_id of this AppComponentSpecsInner.


        :param artefact_id: The artefact_id of this AppComponentSpecsInner.
        :type artefact_id: ArtefactId
        """
